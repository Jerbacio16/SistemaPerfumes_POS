                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="combinacion" id="combinacion" maxlength="80" placeholder="Notas del Perfume">
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Duración:</label>
                            <input type="text" class="form-control" name="duracion" id="duracion" maxlength="80" placeholder="Duración del Perfume">
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Tamaño:</label>
                            <input type="text" class="form-control" name="tamaño" id="tamaño" maxlength="80" placeholder="Tamaño del Perfume">
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                              <label>Proyección:</label>
                              <textarea class="form-control" name="descripcion" id="descripcion" rows="4" placeholder="Proyección del Perfume"></textarea>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Imagen:</label>
