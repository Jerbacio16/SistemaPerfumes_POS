...
Class Venta
{
    ...
    {
        $sql="SELECT v.idventa,DATE(v.fecha_hora) as fecha,v.idcliente,p.nombre as cliente,v.tipo_comprobante,v.serie_comprobante,v.num_comprobante,v.total_venta,v.impuesto,v.estado FROM venta v 
...
ORDER by v.idventa desc";
    ...
    {
        $sql="SELECT v.idventa,v.idcliente,p.nombre as cliente, p.direccion,p.tipo_documento,p.num_documento,p.email,p.telefono v.tipo_comprobante,v.serie_comprobante,v.num_comprobante,date(v.fecha_hora) as fecha,v.impuesto,v.total_venta FROM venta v INNER JOIN persona p on v.idcliente=p.idpersona INNER JOIN usuario u on v.idusuario=u.idusuario WHERE v.idventa='$idventa'";
